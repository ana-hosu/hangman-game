#############################################################################
# Makefile for building: hang
# Generated by qmake (3.1) (Qt 5.9.4)
# Project:  hang.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile hang.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = hang1.0.0
DISTDIR = /home/twoflower/cpp/hang/.tmp/hang1.0.0
LINK          = g++
LFLAGS        = 
...
Makefile: hang.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile hang.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
/usr/lib64/qt5/mkspecs/features/spec_pre.prf:
/usr/lib64/qt5/mkspecs/common/unix.conf:
/usr/lib64/qt5/mkspecs/common/linux.conf:
/usr/lib64/qt5/mkspecs/common/sanitize.conf:
...
distdir: FORCE
	...
	$(COPY_FILE) --parents hangman.h input.h word.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp hangman.cpp input.cpp $(DISTDIR)/
